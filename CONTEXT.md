...
`docs/adr/0001-sobrecarga-dois-limiares-independentes.md` (repo backend) pro racional completo e a
revisão 2026-08-22 (peso por ministério). _Avoid_: "carga pastoral", "fadiga voluntária" — termos
mais abstratos, não usar no código/UI
...
`docs/adr/0003-checklist-nao-bloqueia-geracao.md`, repo backend — o produto não força resposta de
formulário).
