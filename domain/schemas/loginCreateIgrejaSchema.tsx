...
export const LoginCreateIgrejaSchema = z
  .object({
    nome: z.string('Campo obrigatório').min(1, 'Campo obrigatório').max(120, 'Nome deve ter no máximo 120 caracteres'),
    cidade: z.string('Campo obrigatório').min(1, 'Campo obrigatório').max(80, 'Cidade deve ter no máximo 80 caracteres'),
    uf: z.string('Campo obrigatório').min(1, 'Campo obrigatório').length(2, 'UF deve ter 2 caracteres'),
    codigo: z.string('Campo obrigatório').min(1, 'Campo obrigatório').max(32, 'Código deve ter no máximo 32 caracteres'),
    responsavelNome: z.string('Campo obrigatório').min(1, 'Campo obrigatório').max(255, 'Nome deve ter no máximo 255 caracteres'),
    responsavelEmail: z.string('Campo obrigatório').min(1, 'Campo obrigatório').email('E-mail inválido'),
    responsavelSenha: z.string('Campo obrigatório').min(6, 'Senha deve ter no mínimo 6 caracteres'),
    responsavelConfirmarSenha: z.string('Campo obrigatório').min(6, 'Senha deve ter no mínimo 6 caracteres'),
