...
interface ControlledNumberInputProps<FormData extends FieldValues> extends Omit<FancyNumberInputProps, 'value' | 'onChange'> {
  control: Control<FormData>;
  name: Path<FormData>;
}

export default function ControlledNumberInput<FormData extends FieldValues>({ control, name, ...rest }: ControlledNumberInputProps<FormData>) {
  return (
    <Controller
      control={control}
      name={name}
