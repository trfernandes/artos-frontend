...
interface ControlledColorPickerProps<TFormValues extends FieldValues, TName extends Path<TFormValues>> extends Omit<
  ...
  return (
    <Controller
      ...
      render={({ field: { onChange, onBlur, value, disabled }, fieldState: { error } }) => {
        ...
        return <FancyColorPicker {...pickerProps} value={value} onSelectColor={onChange} disabled={effectiveDisabled} />;
      }}
    />
  );
}
