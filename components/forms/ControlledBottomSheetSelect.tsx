...
import FancyBottomSheetSelect, { FancyBottomSheetSelectProps } from '../fields/FancyBottomSheetSelect';
import { View } from 'react-native';

interface ControlledBottomSheetSelectProps<TFormValues extends FieldValues, TName extends Path<TFormValues>>
  extends Pick<
...
export default function ControlledBottomSheetSelect<TFormValues extends FieldValues, TName extends Path<TFormValues>>({
  control,
  name,
  ...rest
}: ControlledBottomSheetSelectProps<TFormValues, TName>) {
